...
<HTML><HEAD><FONT SIZE="4"COLOR="black" FACE="roman">CANDIDATE HOME PAGE
</FONT><br>
<FONT SIZE="4"COLOR="black" FACE="roman">WELCOME Raja
...
<tr>
				<td width="400" align="left">Search Jobs</td>
			...
			<tr>
				...
				<select  name="loc" style="width:165" ><option > - Select -</option><option >seattle</option><option>newyork</option><option>northdakota</option><option>virginia</option><option>southdakota</option><option>Georgia</option><option>washnton dc</option><option>montana</option><option>utah</option><option>california</option></select>	
